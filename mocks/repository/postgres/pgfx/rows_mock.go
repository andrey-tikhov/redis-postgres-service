...
// Source: /Users/andrey.t/go/pkg/mod/github.com/jackc/pgx/v5@v5.3.1/rows.go
...
func (mr *MockRowScannerMockRecorder) ScanRow(rows interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Scan indicates an expected call of Scan.
func (mr *MockCollectableRowMockRecorder) Scan(dest ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
